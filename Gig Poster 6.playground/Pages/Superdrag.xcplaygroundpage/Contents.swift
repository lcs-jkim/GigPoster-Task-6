...
// Subtext #1
canvas.drawText(message: "with", at: Point(x: -180, y: -345), size: 9, kerning: 0)
canvas.drawText(message: "the shambles", at: Point(x: -180, y: -360), size: 9, kerning: 0)
canvas.drawText(message: "and lifter", at: Point(x: -180, y: -375), size: 9, kerning: 0)

// Subtext #2
canvas.drawText(message: "thursday", at: Point(x: -80, y: -345), size: 9, kerning: 0)
canvas.drawText(message: "june 13 1996 / 8:30", at: Point(x: -80, y: -360), size: 9, kerning: 0)
canvas.drawText(message: "no age limit", at: Point(x: -80, y: -375), size: 9, kerning: 0)

//Subtext #3
canvas.drawText(message: "at brick by brick", at: Point(x: 100, y: -345), size: 9, kerning: 0)
canvas.drawText(message: "1130 buenos avenue", at: Point(x: 100, y: -360), size: 9, kerning: 0)
canvas.drawText(message: "san diego, ca", at: Point(x: 100, y: -375), size: 9, kerning: 0)
